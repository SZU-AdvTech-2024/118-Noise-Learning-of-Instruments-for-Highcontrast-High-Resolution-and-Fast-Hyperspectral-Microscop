...
def train(config):
    ...
    # 加载数据集
    path = r'D:\研一\培养计划\Noise-learning-1.0\data\NoiseDataforHoribaLabRAM'
    reader = Read_data(path, config.valid_ratio)
...
def predict(config):
    ...
    model_file = r'D:\研一\培养计划\Noise-learning-1.0\checkpoints\562800.pt'
    # 加载模型参数
